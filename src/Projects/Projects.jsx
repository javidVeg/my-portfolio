    ...
    return (
        <div className='projects-container '>
            ...
            <div className='project-card gap-4 shadow-lg shadow-black'>
                    ...
                    <h1 >
                        "Hello, Apple" is a web based application that I created as part of my devCodeCamp bootcamp capstone project. This Application is a robust
                ...
                <div className='flex flex-row gap-2 md:flex-col'>
                    <button className=' bg-emerald-400 hover:bg-emerald-500 text-white font-bold py-1 px-2 border border-emerald-500 rounded'><a href=''>Visit</a></button>
